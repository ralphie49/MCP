...
**Technology:** Java, Elasticsearch, Ansible, PostgreSQL, TensorFlow

**Invocation Examples:**
- `Performance Optimization Specialist` *(reads configuration from project)*
- `Performance Optimization Specialist (custom configuration)` *(uses provided config)*
- `Performance Optimization Specialist (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "PerformanceOptimizationSpecialist"
  description: "Automates performance optimization with real-time insights"
  version: "2.9.14"
  status: "deprecated"
```
...
3. Verify all required technologies available: Java, Elasticsearch, Ansible, PostgreSQL, TensorFlow
...
- **Supported Technologies:** Java, Elasticsearch, Ansible, PostgreSQL, TensorFlow

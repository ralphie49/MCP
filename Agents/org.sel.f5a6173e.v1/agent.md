...
**Technology:** AWS, Kubernetes, Spring Boot, GCP, GitHub, Django
...
3. Verify all required technologies available: AWS, Kubernetes, Spring Boot, GCP, GitHub, Django
...
- **Supported Technologies:** AWS, Kubernetes, Spring Boot, GCP, GitHub, Django

...
**Technology:** Express.js, React, PostgreSQL, Spring Boot, JavaScript, Django

**Invocation Examples:**
- `Advanced Monitoring Integration` *(reads configuration from project)*
- `Advanced Monitoring Integration (custom configuration)` *(uses provided config)*
- `Advanced Monitoring Integration (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "AdvancedMonitoringIntegration"
  description: "Monitors and tracks monitoring integration metrics"
  version: "3.2.3"
  status: "beta"
```
...
3. Verify all required technologies available: Express.js, React, PostgreSQL, Spring Boot, JavaScript, Django
...
- **Supported Technologies:** Express.js, React, PostgreSQL, Spring Boot, JavaScript, Django

...
**Technology:** Java, Terraform, scikit-learn, Django, Redis, GitLab

**Invocation Examples:**
- `Performance Optimization Optimizer` *(reads configuration from project)*
- `Performance Optimization Optimizer (custom configuration)` *(uses provided config)*
- `Performance Optimization Optimizer (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "PerformanceOptimizationOptimizer"
...
3. Verify all required technologies available: Java, Terraform, scikit-learn, Django, Redis, GitLab
...
- **Supported Technologies:** Java, Terraform, scikit-learn, Django, Redis, GitLab

...
**Technology:** Azure, Elasticsearch, Java, Flask, Terraform, TypeScript, NestJS, Django

**Invocation Examples:**
- `Dynamic Analysis Generator` *(reads configuration from project)*
- `Dynamic Analysis Generator (custom configuration)` *(uses provided config)*
- `Dynamic Analysis Generator (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Azure, Elasticsearch, Java, Flask, Terraform, TypeScript, NestJS, Django
...
- **Supported Technologies:** Azure, Elasticsearch, Java, Flask, Terraform, TypeScript, NestJS, Django

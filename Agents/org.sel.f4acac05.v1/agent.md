...
**Technology:** Docker, JavaScript, GitLab, Redis, Ansible

**Invocation Examples:**
- `Security Review Analyzer` *(reads configuration from project)*
- `Security Review Analyzer (custom configuration)` *(uses provided config)*
- `Security Review Analyzer (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Docker, JavaScript, GitLab, Redis, Ansible
...
- **Supported Technologies:** Docker, JavaScript, GitLab, Redis, Ansible

...
**Technology:** Git, TensorFlow, JavaScript, Ansible, Java

**Invocation Examples:**
- `Refactoring Monitor` *(reads configuration from project)*
- `Refactoring Monitor (custom configuration)` *(uses provided config)*
- `Refactoring Monitor (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Git, TensorFlow, JavaScript, Ansible, Java
...
- **Supported Technologies:** Git, TensorFlow, JavaScript, Ansible, Java

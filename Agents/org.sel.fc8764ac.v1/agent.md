...
**Technology:** Kubernetes, Azure, scikit-learn, Express.js, Vue, Git

**Invocation Examples:**
- `Log Intelligence Generator` *(reads configuration from project)*
- `Log Intelligence Generator (custom configuration)` *(uses provided config)*
- `Log Intelligence Generator (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Kubernetes, Azure, scikit-learn, Express.js, Vue, Git
...
- **Supported Technologies:** Kubernetes, Azure, scikit-learn, Express.js, Vue, Git

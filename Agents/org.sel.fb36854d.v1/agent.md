...
**Technology:** Redis, Git, NestJS, Go, Next.js

**Invocation Examples:**
- `Iac Generation Agent` *(reads configuration from project)*
- `Iac Generation Agent (custom configuration)` *(uses provided config)*
- `Iac Generation Agent (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Redis, Git, NestJS, Go, Next.js
...
- **Supported Technologies:** Redis, Git, NestJS, Go, Next.js

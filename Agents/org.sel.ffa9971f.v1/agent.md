...
**Technology:** AWS, Java, Svelte, MongoDB, Django, Angular, Vue, NestJS

**Invocation Examples:**
- `Reverse Engineering Agent` *(reads configuration from project)*
- `Reverse Engineering Agent (custom configuration)` *(uses provided config)*
- `Reverse Engineering Agent (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: AWS, Java, Svelte, MongoDB, Django, Angular, Vue, NestJS
...
- **Supported Technologies:** AWS, Java, Svelte, MongoDB, Django, Angular, Vue, NestJS

...
**Technology:** Ansible, Kubernetes, GitLab, Git, GitHub

**Invocation Examples:**
- `Migration Generator` *(reads configuration from project)*
- `Migration Generator (custom configuration)` *(uses provided config)*
- `Migration Generator (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Ansible, Kubernetes, GitLab, Git, GitHub
...
- **Supported Technologies:** Ansible, Kubernetes, GitLab, Git, GitHub

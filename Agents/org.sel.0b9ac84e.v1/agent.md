...
**Technology:** Rust, Git, Python, Django, AWS

**Invocation Examples:**
- `Data Modeling Optimizer` *(reads configuration from project)*
- `Data Modeling Optimizer (custom configuration)` *(uses provided config)*
- `Data Modeling Optimizer (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Rust, Git, Python, Django, AWS
...
- **Supported Technologies:** Rust, Git, Python, Django, AWS

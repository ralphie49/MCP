...
## Purpose
Enable **GitHub Copilot** as a specialized **Refactoring Specialist** generating high-quality refactoring solutions adhering to project standards.

**Technology:** JavaScript, Flask, Python, Ember, TypeScript, GitHub

**Invocation Examples:**
- `Refactoring Optimizer` *(reads configuration from project)*
- `Refactoring Optimizer (custom configuration)` *(uses provided config)*
- `Refactoring Optimizer (full execution mode)` *(generates all components)*
...
- **generation**: Generate refactoring artifacts
...
```yaml
project:
  name: "RefactoringOptimizer"
  description: "Optimizes refactoring performance and efficiency"
  version: "4.3.5"
  status: "alpha"
```
...
tasks:
  - name: execute_refactoring
    description: Execute refactoring task
    async: true
  - name: analyze_refactoring_output
    description: Analyze output from refactoring
    async: false
...
**Generation Mode:** Generate refactoring artifacts
```yaml
...
2. Validate specialization: Refactoring
3. Verify all required technologies available: JavaScript, Flask, Python, Ember, TypeScript, GitHub
...
- ✅ Follow best practices for refactoring
...
### Supported Features
- Full Refactoring workflow support
...
- **Agent ID:** unknown
- **Primary Specialization:** Refactoring
- **Domain Areas:** General
- **Supported Technologies:** JavaScript, Flask, Python, Ember, TypeScript, GitHub

---

## 🎯 Objectives

1. **Complete Refactoring Solution Generation**

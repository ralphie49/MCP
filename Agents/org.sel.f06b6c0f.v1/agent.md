...
**Technology:** FastAPI, GitHub, AWS, Angular, Ember

**Invocation Examples:**
- `Refactoring Analyzer` *(reads configuration from project)*
- `Refactoring Analyzer (custom configuration)` *(uses provided config)*
- `Refactoring Analyzer (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: FastAPI, GitHub, AWS, Angular, Ember
...
- **Supported Technologies:** FastAPI, GitHub, AWS, Angular, Ember

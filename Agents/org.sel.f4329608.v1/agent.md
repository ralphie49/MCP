...
**Technology:** Elasticsearch, Git, GitLab, Vue, Azure

**Invocation Examples:**
- `Performance Optimization Monitor` *(reads configuration from project)*
- `Performance Optimization Monitor (custom configuration)` *(uses provided config)*
- `Performance Optimization Monitor (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "PerformanceOptimizationMonitor"
...
3. Verify all required technologies available: Elasticsearch, Git, GitLab, Vue, Azure
...
- **Supported Technologies:** Elasticsearch, Git, GitLab, Vue, Azure

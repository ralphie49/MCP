...
**Technology:** GitLab, AWS, TypeScript, Terraform, Spring Boot, Redis, Docker
...
3. Verify all required technologies available: GitLab, AWS, TypeScript, Terraform, Spring Boot, Redis, Docker
...
- **Supported Technologies:** GitLab, AWS, TypeScript, Terraform, Spring Boot, Redis, Docker

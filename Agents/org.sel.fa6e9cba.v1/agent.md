...
**Technology:** Next.js, Python, PostgreSQL, Svelte, Azure

**Invocation Examples:**
- `Advanced Security Review` *(reads configuration from project)*
- `Advanced Security Review (custom configuration)` *(uses provided config)*
- `Advanced Security Review (full execution mode)` *(generates all components)*
...
3. Verify all required technologies available: Next.js, Python, PostgreSQL, Svelte, Azure
...
- **Supported Technologies:** Next.js, Python, PostgreSQL, Svelte, Azure

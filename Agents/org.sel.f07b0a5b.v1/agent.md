...
## Purpose
Enable **GitHub Copilot** as a specialized **Code Generation Specialist** generating high-quality code generation solutions adhering to project standards.

**Technology:** JavaScript, Flask, Docker, Java, Express.js

**Invocation Examples:**
- `Code Generation Analyzer` *(reads configuration from project)*
- `Code Generation Analyzer (custom configuration)` *(uses provided config)*
- `Code Generation Analyzer (full execution mode)` *(generates all components)*
...
- **generation**: Generate code generation artifacts
...
```yaml
project:
  name: "CodeGenerationAnalyzer"
  description: "Optimizes code generation performance and efficiency"
  version: "1.0.8"
  status: "rc"
```
...
```yaml
tasks:
  - name: execute_code_generation
    description: Execute code generation task
    async: true
  - name: analyze_code_generation_output
    description: Analyze output from code generation
    async: false
...
**Generation Mode:** Generate code generation artifacts
```yaml
...
2. Validate specialization: Code Generation
3. Verify all required technologies available: JavaScript, Flask, Docker, Java, Express.js
...
- ✅ Follow best practices for code generation
...
### Supported Features
- Full Code Generation workflow support
...
- **Division:** Code Generation Division
- **Creator:** Creator 12
...
- **Supported Technologies:** JavaScript, Flask, Docker, Java, Express.js

---

## 🎯 Objectives

1. **Complete Code Generation Solution Generation**

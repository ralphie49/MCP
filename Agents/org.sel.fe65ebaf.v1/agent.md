...
**Technology:** GitHub, Go, TypeScript, Java, PostgreSQL, Azure

**Invocation Examples:**
- `Advanced Refactoring` *(reads configuration from project)*
- `Advanced Refactoring (custom configuration)` *(uses provided config)*
- `Advanced Refactoring (full execution mode)` *(generates all components)*
...
project:
  ...
  description: "Monitors and tracks refactoring metrics"
  version: "3.4.16"
  status: "deprecated"
```
...
3. Verify all required technologies available: GitHub, Go, TypeScript, Java, PostgreSQL, Azure
...
- **Supported Technologies:** GitHub, Go, TypeScript, Java, PostgreSQL, Azure

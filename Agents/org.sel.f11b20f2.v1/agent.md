...
**Technology:** Docker, Azure, AWS, TypeScript, GitHub

**Invocation Examples:**
- `Iac Generation Generator` *(reads configuration from project)*
- `Iac Generation Generator (custom configuration)` *(uses provided config)*
- `Iac Generation Generator (full execution mode)` *(generates all components)*
...
```yaml
project:
  name: "IacGenerationGenerator"
  description: "Intelligently iac generation using advanced techniques"
  version: "4.3.9"
  status: "beta"
```
...
3. Verify all required technologies available: Docker, Azure, AWS, TypeScript, GitHub
...
- **Supported Technologies:** Docker, Azure, AWS, TypeScript, GitHub
